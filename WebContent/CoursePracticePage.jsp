	...
	<aside>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i> Course Header</h3>
				</div>
				</div>
              <div class="col-lg-12">
			  	<table class="table table-advance" id="courseProgress">
			  		<tr>
               		<div class="panel panel-default col-lg-12" style="background: #F6F6F6;">
               		<h4><a href="userPageServlet?searchid=123"><strong>Topic name</strong></a> rated 10 out of 10</h4>
               		<p>Progress</p>
               		</div>
               		</tr>
			  	</table>
